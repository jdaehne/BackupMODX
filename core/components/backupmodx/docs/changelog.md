...
- Log the size of each file in the backup too

### Fixed

- Trim a trailing slash from excluded folders and exclude those folders too
...
- Debug option logging the files to back up and other information in backupmodx.log
